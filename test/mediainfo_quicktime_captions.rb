...
class MediainfoQuicktimeCaptions < ActiveSupport::TestCase
  def setup
    @info = mediainfo_mock "with-quicktime-captions"
  end
  ...
  test "duration" do
    ...
    assert_equal "5s 996ms", @info.duration_before_type_cast
  end

  test "overall bitrate" do
    assert_equal "1 716 Kbps", @info.overall_bit_rate
  end
  
  test "encoded date" do
    assert_equal "", @info.encoded_date
  end
  
  test "tagged date" do
    assert_equal "", @info.tagged_date
  end
  ...
  test "writing library" do
    assert_equal "Apple QuickTime 7.6.9", @info.writing_library
  end
  ...
  test "other stream  id" do
    assert_equal "3", @info.other.stream_id
  end

  test "other stream  type" do
    assert_equal "Time code", @info.other.other_type
  end
  
  test "other   Format" do
    assert_equal "QuickTime TC", @info.other.format
  end

  # test "other encoded date" do
  #   assert_equal "", @info.other.encoded_date
  # end
  # 
  # test "other tagged date" do
  #   assert_equal "", @info.other.tagged_date
  # end
